...
if(isset($_POST['btn-update']))
{
	...
	if($crud->update($id,$fname,$lname, $patient_id,$email,$address,$phone))
	{
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            ...
            <td><input type='text' name='lname' class='form-control' value="<?php echo $lname; ?>" required></td>
				...
				<tr>
						<td>Patient ID</td>
						<td><input type='text' name='patient_id' class='form-control' value="<?php echo $patient_id; ?>" required></td>
				</tr>
