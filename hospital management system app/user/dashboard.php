				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="#"><b>Ousainou</b> just added a new empoyee</a></li>
...
<div class="row">
	<div class="col-md-6">
		<div class="card">
			<div class="header">
				<h4 class="title">Employee Statistics</h4>
				<p class="category">Overall percentage.</p>
			</div>
			<div class="content">
				...
				<div class="footer">
					<div class="chart-legend">
						<i class="fa fa-circle text-info"></i> Doctors
						<i class="fa fa-circle text-danger"></i> Nurses
						<i class="fa fa-circle text-warning"></i> Accountants
					</div>
					<hr>
					<div class="stats">
						<i class="ti-timer"></i> Stats updated 2 days ago
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-md-6">
		<div class="card ">
			<div class="header">
				<h4 class="title">2017 Employment Chart</h4>
				<p class="category">Number of employees employed this year</p>
			</div>
			<div class="content">
				...
				<div class="footer">
					<div class="chart-legend">
						<i class="fa fa-circle text-info"></i> Doctors
						<i class="fa fa-circle text-warning"></i> Nurses
					</div>
					<hr>
					<div class="stats">
