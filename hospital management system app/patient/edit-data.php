...
if(isset($_POST['btn-update']))
{
	...
	if($crud->update($id,$fname,$lname,$email,$address,$phone,$dob,$disease,$nationality))
	{
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            ...
            <td><input type='text' name='phone' class='form-control' value="<?php echo $phone; ?>" required></td>
				...
				<tr>
            <td>Date of Birth</td>
            <td><input type='date' name='dob' class='form-control' value="<?php echo $dob; ?>" required></td>
        </tr>


				<tr>
						<td>Disease</td>
						<td><input type='text' name='disease' class='form-control' value="<?php echo $disease; ?>" required></td>
				</tr>


				<tr>
						<td>Nationality</td>
						<td><input type='text' name='nationality' class='form-control' value="<?php echo $nationality; ?>" required></td>
				</tr>
