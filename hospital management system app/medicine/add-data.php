...
if(isset($_POST['btn-save']))
{
	...
	if($crud->create($name,$medicine_category_id, $description,$price,$manufacturing_company,$status))
	{
...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Medicne Category ID</td>
            <td><input type='text' name='medicine_category_id' class='form-control' required></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type='text' name='price' class='form-control' required></td>
				...
				<tr>
						...
						<td><input type='text' name='manufacturing_company' class='form-control' required></td>
				</tr>
