	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Medicine Category</a>
			</div>
		</div>
	</nav>
...
<div class="container">
<a href="add-data.php" class="btn btn-large btn-info" style="margin-top: 50px; margin-left:0px;"><i class="glyphicon glyphicon-plus"></i> &nbsp; Add New Medicine Category</a>
</div>
<div class="clearfix"></div><br />
<div class="content">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<h4 class="title">Medicine Category</h4>
						</div>
	 ...
	 <?php
	 	if(isset($_POST['save'])){
			 $search = $_POST['search'];
	 	$query = "SELECT * FROM medicine_category WHERE name LIKE '%" .$search. "%' OR description LIKE '%" .$search. "%'" ;
		 }
	 ?>


     <?php
		$query = "SELECT * FROM medicine_category";
		$records_per_page=3;
