...
<div class="container">
<a href="add-data.php" class="btn btn-large btn-info" style="margin-top: 50px; margin-left:0px;"><i class="glyphicon glyphicon-plus"></i> &nbsp; Add Records</a>
</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<h4 class="title">Laboratory Details</h4>
						</div>
