...
if(isset($_POST['btn-save']))
{
	...
	if($crud->create($patient_id,$staff_id,$symptoms,$charge,$date_time))
	{
...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Staff ID</td>
            <td><input type='text' name='staff_id' class='form-control' required></td>
        </tr>

        <tr>
            <td>Symptoms</td>
            <td><input type='text' name='symptoms' class='form-control' required></td>
        </tr>

				<tr>
						<td>Charge</td>
						<td><input type='text' name='charge' class='form-control' required></td>
				</tr>

				<tr>
						<td>Date</td>
						<td><input type='date' name='date_time' class='form-control' required></td>
				</tr>
